...
ccuadd=['0x7e','0x7d','0x7c','0x7b','0x7a','0x79','0x78','0x77']
if len(sys.argv)==2:
    name = sys.argv[1]
    if not name in ccuadd:
        print "CCU address must be in ",shells
        sys.exit(1)

else:
    print "usage: python testCCUandDCDC.py <CCU address>"
    sys.exit(1)
