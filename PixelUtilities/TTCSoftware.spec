%define _package TTCSoftware
%define _packagename TTCSoftware
%define _version __version__
%define _release __build__
%define _prefix  /opt/xdaq
%define _tmppath /tmp
%define _packagedir $BUILD_HOME/TTCSoftware
%define _os linux
...
if [ -d %{_packagedir}/TCPBusAdapter ]; then
	install -m 655 %{_packagedir}/TCPBusAdapter/lib*.so $RPM_BUILD_ROOT/%{_prefix}/lib/
fi
