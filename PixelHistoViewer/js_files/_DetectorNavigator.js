...
DetectorNavigator.WEB_LARGE_WIDTH        = ##WEB_LARGE_WIDTH##;
DetectorNavigator.WEB_LARGE_HEIGHT       = ##WEB_LARGE_HEIGHT##;
DetectorNavigator.WEB_MINI_WIDTH         = ##WEB_MINI_WIDTH##;
DetectorNavigator.WEB_MINI_HEIGHT        = ##WEB_MINI_HEIGHT##;
DetectorNavigator.WEB_BLARGE_WIDTH			 = ##WEB_BLARGE_WIDTH##;
DetectorNavigator.WEB_BLARGE_HEIGHT 		 = ##WEB_BLARGE_HEIGHT##;
DetectorNavigator.WEB_BMINI_WIDTH 			 = ##WEB_BMINI_WIDTH##;
DetectorNavigator.WEB_BMINI_HEIGHT			 = ##WEB_BMINI_HEIGHT##;
DetectorNavigator.WEB_XOFFSET         	 = ##WEB_XOFFSET##;
DetectorNavigator.WEB_YOFFSET         	 = ##WEB_YOFFSET##;
DetectorNavigator.WEB_ROC_SIZE         	 = ##WEB_ROC_SIZE##;
DetectorNavigator.WEB_DISC_X        		 = ##WEB_DISC_X##;
DetectorNavigator.WEB_DISC_Y        		 = ##WEB_DISC_Y##;
DetectorNavigator.WEB_BLADE_HI       		 = ##WEB_BLADE_HI##;
DetectorNavigator.WEB_BLADE_LO       		 = ##WEB_BLADE_LO##;
DetectorNavigator.WEB_ROC_OFFSET       	 = ##WEB_ROC_OFFSET##;
DetectorNavigator.WEB_BLYR_XOFF 				 = ##WEB_BLYR_XOFF##;
DetectorNavigator.WEB_BLYR_YOFF 				 = ##WEB_BLYR_YOFF##;
DetectorNavigator.WEB_BROC_WIDTH				 = ##WEB_BROC_WIDTH##;
DetectorNavigator.WEB_BROC_HEIGHT 			 = ##WEB_BROC_HEIGHT##;
DetectorNavigator.WEB_BROW_OFFSET 			 = ##WEB_BROW_OFFSET##;
DetectorNavigator.WEB_BCOL_OFFSET 			 = ##WEB_BCOL_OFFSET##;
DetectorNavigator.BPIX_LYR_COLS					 = ##BPIX_LYR_COLS##;
DetectorNavigator.BPIX_LYR_ROWS				   = 
	[##BPIX_LYR1_ROWS##,##BPIX_LYR2_ROWS##,##BPIX_LYR3_ROWS##];
...
var q 						       	 = 
	[ 
		[	//4-pplaquette panel type 1
			[##PNL1_PLAQ1_H##,##PNL1_PLAQ1_L##,0,
				[ [2,1,-1,(##PNL1_PLAQ1_H## + ##PNL1_PLAQ1_L##)/2]  ,
					[]]	,
				0.0, 0.5],
			[##PNL1_PLAQ2_H##,##PNL1_PLAQ2_L##,##PNL1_PLAQ2_M##,
				[ [3,2,-1,(##PNL1_PLAQ2_L## + ##PNL1_PLAQ2_M## - ##WEB_ROC_OFFSET##)/2]	,
					[3,3, 1,(##PNL1_PLAQ2_H## + ##PNL1_PLAQ2_M##)/2]] ,
				0.5, 1.0],
			[##PNL1_PLAQ3_H##,##PNL1_PLAQ3_L##,##PNL1_PLAQ3_M##,
				[ [4,3,-1,(##PNL1_PLAQ3_L## + ##PNL1_PLAQ3_M## - ##WEB_ROC_OFFSET##)/2]	,
					[4,4, 1,(##PNL1_PLAQ3_H## + ##PNL1_PLAQ3_M##)/2]] ,
				1.0, 1.5],
			[##PNL1_PLAQ4_H##,##PNL1_PLAQ4_L##,0,
				[ [5,4,-1,(##PNL1_PLAQ4_H## + ##PNL1_PLAQ4_L##)/2]	,
					[]] ,
				1.5, 2.0]
		],
		[ //3-pplaquette panel type 2
			[##PNL2_PLAQ1_H##,##PNL2_PLAQ1_L##,##PNL2_PLAQ1_M##,
				[ [3,2,-1,(##PNL2_PLAQ1_L## + ##PNL2_PLAQ1_M## - ##WEB_ROC_OFFSET##)/2]	,
					[3,3, 1,(##PNL2_PLAQ1_H## + ##PNL2_PLAQ1_M##)/2]] ,
				0.5, 1.0],
			[##PNL2_PLAQ2_H##,##PNL2_PLAQ2_L##,##PNL2_PLAQ2_M##,
				[ [4,3,-1,(##PNL2_PLAQ2_L## + ##PNL2_PLAQ2_M## - ##WEB_ROC_OFFSET##)/2]	,
					[4,4, 1,(##PNL2_PLAQ2_H## + ##PNL2_PLAQ2_M##)/2]] ,
				1.0, 1.5],
			[##PNL2_PLAQ3_H##,##PNL2_PLAQ3_L##,##PNL2_PLAQ3_M##,
				[ [5,4,-1,(##PNL2_PLAQ3_L## + ##PNL2_PLAQ3_M## - ##WEB_ROC_OFFSET##)/2]	,
					[5,5, 1,(##PNL2_PLAQ3_H## + ##PNL2_PLAQ3_M##)/2]] ,
				1.5, 2.0]
		]	
	];
