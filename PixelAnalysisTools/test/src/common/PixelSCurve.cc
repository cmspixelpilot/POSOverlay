...
//	cout << mthn << "roc: " << roc.str() << endl;
	...
	c4L2x3->cd(1) ;
	roc.str("");
	roc <<rng.str()<<"_ROC"<< 5;//7;
	histoManager->draw(roc.str(),kk);
	c4L2x3->cd(2) ;
	roc.str("");
	roc <<rng.str()<<"_ROC"<< 4;//6;
	histoManager->draw(roc.str(),kk);
	c4L2x3->cd(3) ;
	roc.str("");
	roc <<rng.str()<<"_ROC"<< 3;//5;
	histoManager->draw(roc.str(),kk);
	c4L2x3->cd(4) ;
	roc.str("");
	roc <<rng.str()<<"_ROC"<< 0;//2;
	histoManager->draw(roc.str(),kk);
	c4L2x3->cd(5) ;
	roc.str("");
	roc <<rng.str()<<"_ROC"<< 1;//3;
	histoManager->draw(roc.str(),kk);
	c4L2x3->cd(6) ;
	roc.str("");
	roc <<rng.str()<<"_ROC"<< 2;//4;
	histoManager->draw(roc.str(),kk);
	c4L2x3->Write() ;
	...
	c4L2x4->cd(1) ;
	roc.str("");
	roc <<rng.str()<<"_ROC"<< 7;//15;
	histoManager->draw(roc.str(),kk);
	c4L2x4->cd(2) ;
	roc.str("");
	roc <<rng.str()<<"_ROC"<< 6;//14;
	histoManager->draw(roc.str(),kk);
	c4L2x4->cd(3) ;
	roc.str("");
	roc <<rng.str()<<"_ROC"<< 5;//13;
	histoManager->draw(roc.str(),kk);
	c4L2x4->cd(4) ;
	roc.str("");
	roc <<rng.str()<<"_ROC"<< 4;//12;
	histoManager->draw(roc.str(),kk);
	c4L2x4->cd(5) ;
	roc.str("");
	roc <<rng.str()<<"_ROC"<< 0;//8;
	histoManager->draw(roc.str(),kk);
	c4L2x4->cd(6) ;
	roc.str("");
	roc <<rng.str()<<"_ROC"<< 1;//9;
	histoManager->draw(roc.str(),kk);
	c4L2x4->cd(7) ;
	roc.str("");
	roc <<rng.str()<<"_ROC"<< 2;//10;
	histoManager->draw(roc.str(),kk);
	c4L2x4->cd(8) ;
	roc.str("");
	roc <<rng.str()<<"_ROC"<< 3;//11;
	histoManager->draw(roc.str(),kk);
	c4L2x4->Write() ;
	...
	c4L1x5->cd(1) ;
	roc.str("");
	roc <<rng.str()<<"_ROC"<< 0;//20;
	histoManager->draw(roc.str(),kk);
	c4L1x5->cd(2) ;
	roc.str("");
	roc <<rng.str()<<"_ROC"<< 1;//19;
	histoManager->draw(roc.str(),kk);
	c4L1x5->cd(3) ;
	roc.str("");
	roc <<rng.str()<<"_ROC"<< 2;//18;
	histoManager->draw(roc.str(),kk);
	c4L1x5->cd(4) ;
	roc.str("");
	roc <<rng.str()<<"_ROC"<< 3;//17;
	histoManager->draw(roc.str(),kk);
	c4L1x5->cd(5) ;
	roc.str("");
	roc <<rng.str()<<"_ROC"<< 4;//16;
	histoManager->draw(roc.str(),kk);
	c4L1x5->Write() ;
      }	      
    }
	...
	c3L2x3->cd(1) ;
	roc.str("");
	roc <<rng.str()<<"_ROC"<< 5;//5;
	histoManager->draw(roc.str(),kk);
	c3L2x3->cd(2) ;
	roc.str("");
	roc <<rng.str()<<"_ROC"<< 4;//4;
	histoManager->draw(roc.str(),kk);
	c3L2x3->cd(3) ;
	roc.str("");
	roc <<rng.str()<<"_ROC"<< 3;//3;
	histoManager->draw(roc.str(),kk);
	c3L2x3->cd(4) ;
	roc.str("");
	roc <<rng.str()<<"_ROC"<< 0;//0;
	histoManager->draw(roc.str(),kk);
	c3L2x3->cd(5) ;
	roc.str("");
	roc <<rng.str()<<"_ROC"<< 1;//1;
	histoManager->draw(roc.str(),kk);
	c3L2x3->cd(6) ;
	roc.str("");
	roc <<rng.str()<<"_ROC"<< 2;//2;
	histoManager->draw(roc.str(),kk);
	c3L2x3->Write() ;
	...
	c3L2x4->cd(1) ;
	roc.str("");
	roc <<rng.str()<<"_ROC"<< 7;//13;
	histoManager->draw(roc.str(),kk);
	c3L2x4->cd(2) ;
	roc.str("");
	roc <<rng.str()<<"_ROC"<< 6;//12;
	histoManager->draw(roc.str(),kk);
	c3L2x4->cd(3) ;
	roc.str("");
	roc <<rng.str()<<"_ROC"<< 5;//11;
	histoManager->draw(roc.str(),kk);
	c3L2x4->cd(4) ;
	roc.str("");
	roc <<rng.str()<<"_ROC"<< 4;//10;
	histoManager->draw(roc.str(),kk);
	c3L2x4->cd(5) ;
	roc.str("");
	roc <<rng.str()<<"_ROC"<< 0;//6;
	histoManager->draw(roc.str(),kk);
	c3L2x4->cd(6) ;
	roc.str("");
	roc <<rng.str()<<"_ROC"<< 1;//7;
	histoManager->draw(roc.str(),kk);
	c3L2x4->cd(7) ;
	roc.str("");
	roc <<rng.str()<<"_ROC"<< 2;//8;
	histoManager->draw(roc.str(),kk);
	c3L2x4->cd(8) ;
	roc.str("");
	roc <<rng.str()<<"_ROC"<< 3;//9;
	histoManager->draw(roc.str(),kk);
	c3L2x4->Write() ;
	...
	c3L2x5->cd(1) ;
	roc.str("");
	roc <<rng.str()<<"_ROC"<< 9;//23;
	histoManager->draw(roc.str(),kk);
	c3L2x5->cd(2) ;
	roc.str("");
	roc <<rng.str()<<"_ROC"<< 8;//22;
	histoManager->draw(roc.str(),kk);
	c3L2x5->cd(3) ;
	roc.str("");
	roc <<rng.str()<<"_ROC"<< 7;//21;
	histoManager->draw(roc.str(),kk);
	c3L2x5->cd(4) ;
	roc.str("");
	roc <<rng.str()<<"_ROC"<< 6;//20;
	histoManager->draw(roc.str(),kk);
	c3L2x5->cd(5) ;
	roc.str("");
	roc <<rng.str()<<"_ROC"<< 5;//19;
	histoManager->draw(roc.str(),kk);
	c3L2x5->cd(6) ;
	roc.str("");
	roc <<rng.str()<<"_ROC"<< 0;//14;
	histoManager->draw(roc.str(),kk);
	c3L2x5->cd(7) ;
	roc.str("");
	roc <<rng.str()<<"_ROC"<< 1;//15;
	histoManager->draw(roc.str(),kk);
	c3L2x5->cd(8) ;
	roc.str("");
	roc <<rng.str()<<"_ROC"<< 2;//16;
	histoManager->draw(roc.str(),kk);
	c3L2x5->cd(9) ;
	roc.str("");
	roc <<rng.str()<<"_ROC"<< 3;//17;
	...
	c4R2x3->cd(1) ;
	roc.str("");
	roc <<rng.str()<<"_ROC"<< 5;//15;
	histoManager->draw(roc.str(),kk);
	c4R2x3->cd(2) ;
	roc.str("");
	roc <<rng.str()<<"_ROC"<< 4;//14;
	histoManager->draw(roc.str(),kk);
	c4R2x3->cd(3) ;
	roc.str("");
	roc <<rng.str()<<"_ROC"<< 3;//16;
	histoManager->draw(roc.str(),kk);
	c4R2x3->cd(4) ;
	roc.str("");
	roc <<rng.str()<<"_ROC"<< 0;//16;
	histoManager->draw(roc.str(),kk);
	c4R2x3->cd(5) ;
	roc.str("");
	roc <<rng.str()<<"_ROC"<< 1;//17;
	histoManager->draw(roc.str(),kk);
	c4R2x3->cd(6) ;
	roc.str("");
	roc <<rng.str()<<"_ROC"<< 2;//18;
	...
	c4R2x4->cd(1) ;
	roc.str("");
	roc <<rng.str()<<"_ROC"<< 7;//8;
	histoManager->draw(roc.str(),kk);
	c4R2x4->cd(2) ;
	roc.str("");
	roc <<rng.str()<<"_ROC"<< 6;//7;
	histoManager->draw(roc.str(),kk);
	c4R2x4->cd(3) ;
	roc.str("");
	roc <<rng.str()<<"_ROC"<< 5;//6;
	histoManager->draw(roc.str(),kk);
	c4R2x4->cd(4) ;
	roc.str("");
	roc <<rng.str()<<"_ROC"<< 4;//5;
	histoManager->draw(roc.str(),kk);
	c4R2x4->cd(5) ;
	roc.str("");
	roc <<rng.str()<<"_ROC"<< 0;//9;
	histoManager->draw(roc.str(),kk);
	c4R2x4->cd(6) ;
	roc.str("");
	roc <<rng.str()<<"_ROC"<< 1;//10;
	histoManager->draw(roc.str(),kk);
	c4R2x4->cd(7) ;
	roc.str("");
	roc <<rng.str()<<"_ROC"<< 2;//11;
	histoManager->draw(roc.str(),kk);
	c4R2x4->cd(8) ;
	roc.str("");
	roc <<rng.str()<<"_ROC"<< 3;//12;
	histoManager->draw(roc.str(),kk);
	c4R2x4->Write() ;
	...
	c4R1x5->cd(4) ;
	roc.str("");
	roc <<rng.str()<<"_ROC"<< 3;//1;
	histoManager->draw(roc.str(),kk);
	c4R1x5->cd(5) ;
	roc.str("");
	roc <<rng.str()<<"_ROC"<< 4;//0;
	histoManager->draw(roc.str(),kk);
	c4R1x5->Write() ;
      }      
    }
	...
	c3R2x3->cd(1) ;
	roc.str("");
	roc <<rng.str()<<"_ROC"<< 5;//20;
	histoManager->draw(roc.str(),kk);
	c3R2x3->cd(2) ;
	roc.str("");
	roc <<rng.str()<<"_ROC"<< 4;//19;
	histoManager->draw(roc.str(),kk);
	c3R2x3->cd(3) ;
	roc.str("");
	roc <<rng.str()<<"_ROC"<< 3;//18;
	histoManager->draw(roc.str(),kk);
	c3R2x3->cd(4) ;
	roc.str("");
	roc <<rng.str()<<"_ROC"<< 0;//21;
	histoManager->draw(roc.str(),kk);
	c3R2x3->cd(5) ;
	roc.str("");
	roc <<rng.str()<<"_ROC"<< 1;//22;
	histoManager->draw(roc.str(),kk);
	c3R2x3->cd(6) ;
	roc.str("");
	roc <<rng.str()<<"_ROC"<< 2;//23;
	histoManager->draw(roc.str(),kk);
	c3R2x3->Write() ;
	...
	c3R2x5->cd(1) ;
	roc.str("");
	roc <<rng.str()<<"_ROC"<< 9;//4;
	histoManager->draw(roc.str(),kk);
	c3R2x5->cd(2) ;
	roc.str("");
	roc <<rng.str()<<"_ROC"<< 8;//3;
	histoManager->draw(roc.str(),kk);
	c3R2x5->cd(3) ;
	roc.str("");
	roc <<rng.str()<<"_ROC"<< 7;//2;
	histoManager->draw(roc.str(),kk);
	c3R2x5->cd(4) ;
	roc.str("");
	roc <<rng.str()<<"_ROC"<< 6;//1;
	histoManager->draw(roc.str(),kk);
	c3R2x5->cd(5) ;
	roc.str("");
	roc <<rng.str()<<"_ROC"<< 5;//0;
	histoManager->draw(roc.str(),kk);
	c3R2x5->cd(6) ;
	roc.str("");
	roc <<rng.str()<<"_ROC"<< 0;//5;
	histoManager->draw(roc.str(),kk);
	c3R2x5->cd(7) ;
	roc.str("");
	roc <<rng.str()<<"_ROC"<< 1;//6;
	histoManager->draw(roc.str(),kk);
	c3R2x5->cd(8) ;
	roc.str("");
	roc <<rng.str()<<"_ROC"<< 2;//7;
	histoManager->draw(roc.str(),kk);
	c3R2x5->cd(9) ;
	roc.str("");
	roc <<rng.str()<<"_ROC"<< 3;//8;
	histoManager->draw(roc.str(),kk);
	c3R2x5->cd(10) ;
	roc.str("");
	roc <<rng.str()<<"_ROC"<< 4;//9;
	histoManager->draw(roc.str(),kk);
	c3R2x5->Write() ;
      }
    }
