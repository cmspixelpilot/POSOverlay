...
for fed in range(40):
    ...
    if nerr>0:
        print "fed %2d has %d errors (%.1e) (Event Number Errors:  %d (%.1e), Trailer Errors, %d (%.1e))" %(fed,nerr,nerr/ntriggers,nerrene,nerrene/ntriggers,nerrtra,nerrtra/ntriggers)
print "FED errors      %d (%.1e)" %(totalErrors, totalErrors/ntriggers)
